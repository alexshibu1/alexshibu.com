...
export const coffeeShops: CoffeeShop[] = [
  ...
  },
  {
    ...
    rating: 9,
    review:
      "Great coffee. Right viscosity maybe it's just the way I like my coffee but I need more sugar. I have a ton of time here in at the airport",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    ...
    shopName: "Costa Coffee (Warsaw, Poland)",
    rating: 9.2,
    review:
      "Probably the best cold drink I've had. There is coffee in it but chocolate is the think I ran across Krakow old city at 4 40",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    id: "krakow-resort-july-18-2025",
    date: "July 18th, 2025",
    drink: "Cappuccino",
    shopName: "Resort Café (Krakow, Poland)",
    rating: 9.2,
    review:
      "Simply great cappuccino. you can have 4 of these like pop cakes and not feel the effects it doesn’t have the crazy caffeine I feel. Best when drinking after a 5k in the morning around the village",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    id: "villars-lodge-aug-3-2025",
    date: "Aug 3rd, 2025",
    drink: "Cappuccino",
    shopName: "Villars Lodge (Villars, Switzerland)",
    rating: 9,
    review:
      "Great coffee even better after an awesome run with friends in the morning chill of Villars. Also a super expensive place to stay so I’d expect the coffee to be great. It’s great but it’s not peak. Also the staff are quite unique. They are students in training. Like pro restaurant management school or something. Thank you Villars for the free stay",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    id: "boreal-aug-10-2025",
    date: "Aug 10th, 2025",
    drink: "Mocha Latte",
    shopName: "Boreal Coffee Roasters (Geneva, Switzerland)",
    rating: 9.65,
    review:
      "Almost the perfect coffee I don’t think there’s anything wrong with this coffee really good coffee just the amount of sweetness, not too sweet not too dark. Not too liquidy, but not not liquidy. If you’re really nice vibe sitting outside in the Geneva, summer was really nice. But when I compare it to Canadian prices from six francs for a small coffee, that’s pretty much double which is insane but then for people here it’s nothing.",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    id: "ask-tea-sept-4-2025",
    date: "Sept 4th, 2025",
    drink: "Strong Tea",
    shopName: "A.S.K Tea Hub (Muthalakodam, India)",
    rating: 0,
    review:
      "Got food poisoning for a week after this boi. But the run before was nice. Would not recommend.",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
    id: "shajis-shop-sept-20-2025",
    date: "Sept 20th, 2025",
    drink: "Lemonade (Passion Fruit)",
    shopName: "Meenakshi Naranga Vellakada / Shaji’s Shop (Thodupuzha, India)",
    rating: 9.4,
    review:
      "Not coffee but amazing drink. He adds passion fruit into it. But would not recommend traveling all the way to India to try this. Lol.",
    isChain: false,
    location: DEFAULT_LOCATION,
  },
  {
