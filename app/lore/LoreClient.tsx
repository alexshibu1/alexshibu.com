...
const LORE: LoreItem[] = [
  {
    ...
    {
    id: "syro-shark-2026-07",
    date: "07.2026",
    line: "Pitched at Syro Shark in Chicago",
    more: "I got the opportunity to go for the Silver Jubilee of the Chicago Syro Malabar Diocese where I pitched Avalonn for Syro Shark Tank. We didn't win. Met some really incredible people and mentors. Learned a hard lesson about what actual traction looks like.",

    links: [
      {
        label: "Instagram",
        url: "https://www.instagram.com/p/Dc0g1k7s2eC/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
      },
      {
        label: "Pitch video",
        url: "https://youtu.be/o5b-4m51GvM?si=Hwm8GFF8nGXcWsQN",
      }
    ]
  },

  {
    ...
    links: [
      {
        label: "Instagram",
        url: "https://www.instagram.com/p/DalJy7MDuJn/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
      },
    ],
  },
  {
  ...
  {
    id: "ninebot-scooter-trash-2021-01",
    date: "01.2021",
    ...
    <li>
      ...
      <button
        ...
        className={[
          ...
          "md:hidden",
          isExpanded
            ? "bg-red-50/35 border-l-2 border-red-300 pl-2.5"
      ...
      >
        <span className="text-sm text-gray-500 tabular-nums leading-snug group-hover:text-gray-700">
          {item.date}
        </span>

        <span className="min-w-0">
          <span className="block text-sm text-gray-900 leading-snug truncate group-hover:underline group-hover:decoration-red-300 group-hover:underline-offset-4">
            {item.line}
          </span>
        </span>
      </button>
